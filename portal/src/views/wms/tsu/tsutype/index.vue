...
let resultList = [
  { wb: 'WB1', pid: 'PID1', custom_status: 'Status1', flightNo: 'Flight1', flightDate: '2024-03-04', storageArea: 'Area1', storageLocation: 'Location1' },
  { wb: 'WB2', pid: 'PID2', custom_status: 'Status2', flightNo: 'Flight2', flightDate: '2024-03-05', storageArea: 'Area2', storageLocation: 'Location2' },
  // test data
];
