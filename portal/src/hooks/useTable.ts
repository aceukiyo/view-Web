...
export const useTable = (
  ...
  /**
   * @description reset table data
   * @return void
   * */
  const reset = () => {
    state.pageable.pageNum = 1;
    // When resetting the search form, reset the default search parameters if they exist
  ...
  /**
   * @description the number of items per page changes
